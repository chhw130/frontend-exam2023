const exceptionTypes = {
  ...
  NotImplemented_50001 : { name : 'NotImplemented',  isError : false, code : 50000, message : '아직 구현되지 않은 기능입니다..'},
};

const getWeatherFromServerError = () => {
  throw exceptionTypes.NotImplemented_50001;
};

/*
 abnormal 문제까지 해결하셨나요?
 그럼 해당코드에서 getWeatherFromServerAbnormal 함수 대신 
 getWeatherFromServerErrorCase를 호출해주세요.
